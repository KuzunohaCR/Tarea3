...
public class EstudianteDAO extends PersonaDAO{
 ...
 BufferedWriter writer = null;
        try {
            writer = new BufferedWriter(new FileWriter("c:\\dev\\estudiante.csv"));
            writer.write(this.toCSVLine((Estudiante)newPersona));
            writer.close();
    ...
    public List<Persona> findAll() {
        ...
        try {
            File file = new File("c:\\dev\\estudiante.csv");
    ...
    public String toCSVLine(Object objecto) {
        Estudiante tmp = (Estudiante) objecto;
        return tmp.getCarrera() + "," + tmp.getCreditosMatriculados() + "," + tmp.getId() + "," + tmp.getNombre() + "," + tmp.getApellido() + "," + tmp.getIdentificacion() + "\n";
